...
def search_e2e(gsi, num_of_boards, dataset_id, queries_path):
    ...
    hf = h5py.File(queries_path, 'r')
    key_list = list(hf.keys())
    np_queries = np.array(hf.get(key_list[0]))
    ...
    for i in range(num_of_iter):
        distance, indices, search_time, status = search.knn_composite_cosine_by_hdf(allocation_id, dataset_id,
                                                                                    queries_path, topk=25)
        if status != "OK":
...
def search_multiple(num_boards, dataset):
    resultt_time_1 = search_e2e(gsi_api, num_boards, dataset,
                                "/efs/data/public/scruminators/any_vision/queries_hdf/queries_1.h5")
    resultt_time_10 = search_e2e(gsi_api, num_boards, dataset,
                                 "/efs/data/public/scruminators/any_vision/queries_hdf/queries_10.h5")
    resultt_time_50 = search_e2e(gsi_api, num_boards, dataset,
                                 "/efs/data/public/scruminators/any_vision/queries_hdf/queries_50.h5")
    resultt_time_100 = search_e2e(gsi_api, num_boards, dataset,
                                  "/efs/data/public/scruminators/any_vision/queries_hdf/queries_100.h5")
    resultt_time_1000 = search_e2e(gsi_api, num_boards, dataset,
                                   "/efs/data/public/scruminators/any_vision/queries_hdf/queries_1000.h5")
...
#convert_np_to_hdf("/efs/data/public/scruminators/any_vision/queries_hdf/queries_1.h5",
#                  np.load("/efs/data/qa/any_vision/queries_1.npy"))
#convert_np_to_hdf("/efs/data/public/scruminators/any_vision/queries_hdf/queries_10.h5",
#                  np.load("/efs/data/qa/any_vision/queries_10.npy"))
#convert_np_to_hdf("/efs/data/public/scruminators/any_vision/queries_hdf/queries_50.h5",
#                  np.load("/efs/data/qa/any_vision/queries_50.npy"))
#convert_np_to_hdf("/efs/data/public/scruminators/any_vision/queries_hdf/queries_100.h5",
#                  np.load("/efs/data/qa/any_vision/queries_100.npy"))
#convert_np_to_hdf("/efs/data/public/scruminators/any_vision/queries_hdf/queries_1000.h5",
#                  np.load("/efs/data/qa/any_vision/queries_1000.npy"))
