...
class GSIConfig(object):
    ...
    FLOAT32_SERVER_HOST = os.getenv("FLOAT32_NEURAL_SERVER_HOST", "localhost")

    FLOAT32_SERVER_PORT = os.getenv("FLOAT32_NEURAL_SERVER_PORT", "7761")
    ...
    def __init__(self, log_level="INFO", float32_host=None, float32_port=None):
        ...
        self.float32_neural_base_url = f"http://{float32_host}:{float32_port}"
...
class Float_GSI(object):
    ...
    def request_allocation(self, num_boards):
        ...
        response = requests.post(f"{self.conf.float32_neural_base_url}/allocate", json=request)
    ...
    def delete_allocation(self, alloc_id):
        ...
        response = requests.post(f"{self.conf.float32_neural_base_url}/deallocate", json=request)
    ...
    def import_dataset(self, dataset_path):
        ...
        response = requests.post(f"{self.conf.float32_neural_base_url}/import/dataset", json=request)
    ...
    def load_data(self, alloc_id, dataset_id, neural_matrix_path,

                  hamming_k=3000, normalize=False, typical_nqueries=1, max_nqueries=3100, topk=10):
        ...
        request = {
            ...
            "neuralMatrixPath": neural_matrix_path,
        ...
        response = requests.post(f"{self.conf.float32_neural_base_url}/loadDataset", json=request)
    ...
    def unload_data(self, alloc_id, dataset_id):
        ...
        response = requests.post(f"{self.conf.float32_neural_base_url}/unloadDataset", json=request)
    ...
    def add_data(self, dataset_id, additional_data):
        ...
        response = requests.post(f"{self.conf.float32_neural_base_url}/addData", json=request)
    ...
    def remove_data(self, dataset_id, indices):
        ...
        response = requests.post(f"{self.conf.float32_neural_base_url}/removeData", json=request)
...
class Float_Search(object):
    ...
    def knn_composite_cosine(self, alloc_id, dataset_id, queries_path):
        ...
        response = requests.post(f"{self.conf.float32_neural_base_url}/search", json=request)
    ...
    def knn_composite_cosine_by_queries(self, alloc_id, dataset_id, queries):
        ...
        response = requests.post(f"{self.conf.float32_neural_base_url}/searchByQueriesList", json=request)
    ...
    def knn_composite_cosine_by_hdf(self, alloc_id, dataset_id, hdf_queries_path):
